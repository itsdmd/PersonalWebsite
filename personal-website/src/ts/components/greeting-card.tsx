...
function greetingCard() {
	return (
		<div className="_greeting-card-wrapper flex justify-center relative">
			<motion.div
				className="_greeting-card-shadow absolute dark:bg-d-bg bg-l-bg blur-xl drop-shadow-2xl flex h-40 items-center justify-center max-w-[66rem] md:h-96 md:mt-[22rem] mt-64 rounded-3xl sm:h-60 w-11/12"
				initial={{ opacity: 0 }}
				animate={{ opacity: 1 }}
			...
			>
				<div className="translate-y-4">
					<motion.h1
						className="_greeting-card-text font-bold font-monospace md:text-7xl dark:shadow-gray-light shadow-l-bg-dark sm:text-5xl text-4xl text-center text-shadow-lg dark:text-white text-l-black"
						initial={{ opacity: 0 }}
						animate={{ opacity: 1 }}
